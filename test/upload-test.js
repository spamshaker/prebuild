...
// standard linter issue: ./test/upload-test.js:3:48: Parsing error: Unexpected token assert (null)
// import pkg from 'a-native-module/package.json' with { type: 'json' }
const require = createRequire(import.meta.url)
const pkg = require('a-native-module/package.json')
